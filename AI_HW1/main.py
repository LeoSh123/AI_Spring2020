...
def toy_map_problem_experiments():
    ...
    result = aStar.solve_problem(toy_map_problem)
    print(result)
...
def mda_problem_with_astar_epsilon_experiments():
    ...
    astarEpsilon = AStarEpsilon(MDAMSTAirDistHeuristic,
...
def mda_problem_anytime_astar_experiments():
    ...
    anytimeASTAR = AnytimeAStar(MDAMSTAirDistHeuristic, max_nr_states_to_expand_per_iteration=150)
